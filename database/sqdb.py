"""
SqDB class handles sqlite operations. This is a wrapper around sqlite3 standard module from python.
"""
import logging
import sqlite3
...
class SqDB:
    ...
    def insert_update_delete_data(self, sql: str, data: list | tuple):
        """
